function ListItem(){
	...
	function initialize(){
		...
		container.addEventListener("button-click",onBClick);
		}else{
container.addEventListener("touchstart",onTouchStart);
	...
	evt.cid = _id;
	evt.initEvent("datasend",true,true);
	...
	function onResize(event){
		contentContainer.style.width = (container.clientWidth-imageContainer.clientWidth-60)+"px";
	}
